...
# URL to make HTTP POST request to create a user
CREATE_USER_URL = reverse('user:create')
# URL to make HTTP POST request to generate token
...
class PublicUserApiTests(TestCase):
    ...
    def test_create_valid_user_success(self):
        ...
        # Test the User object is actually created
    ...
    def test_create_token_for_user(self):
        ...
        # res is supposed to contain a Token,
        # a key called token should be in res.data
    ...
    def test_create_token_no_user(self):
        ...
        # Make request without creating user.
        res = self.client.post(TOKEN_URL, payload)
        self.assertNotIn('token', res.data)
        self.assertEqual(res.status_code, status.HTTP_400_BAD_REQUEST)
...
class PrivateUserApiTests(TestCase):
    ...
    def setUp(self):
        ...
        self.client = APIClient()
        # helper function that makes it easy to simulate
        # or making authenticated requests
    ...
    def test_update_user_profile(self):
        ...
        # DB helper function to update user with the latest values from db
